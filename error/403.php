...
<main>
    <div class="container">
        <section class="section min-vh-100 d-flex flex-column align-items-center justify-content-center">
            <img src="<?= base_url('assets/uploads/static/403.svg'); ?>" class="img-fluid" alt="Forbidden" height="200" width="200">
            <h3 class="display-1 fw-bold text-warning text-center">403</h3>
            <h4 class="mb-4 text-center">Halaman Tidak Dapat Diakses.</h4>
