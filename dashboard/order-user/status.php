...
<div class="pagetitle">
    <div class="d-flex justify-content-between align-items-center gap-2 mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="<?= base_url('dashboard/order-user/show.php'); ?>" class="btn btn-sm px-lg-3 btn-light border-secondary">Semua</a>
            ...
            ?>
                <a href="<?= base_url('dashboard/order-user/status.php?status=' . urlencode($data_status_pesanan['status'])); ?>" class="btn btn-sm px-lg-3 <?= ($status === $data_status_pesanan['status']) ? $btn_style : 'btn-light border-secondary'; ?>">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <form method="post" action="<?= base_url('dashboard/order-user/action.php?update-order-status=' . $data['id_pesanan'] . '&current-status=' . $data['status']); ?>">
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('dashboard/order-user/detail.php?order-id=' . $data['id_pesanan']); ?>" class="btn btn-light">
