...
<div class="pagetitle">
    <div class="d-flex justify-content-between align-items-center gap-2 mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="<?= base_url('dashboard/order-cashier/show.php'); ?>" class="btn btn-sm px-lg-3 btn-light border-secondary">Semua</a>
            ...
            ?>
                <a href="<?= base_url('dashboard/order-cashier/status.php?status=' . urlencode($data_status_pesanan['status'])); ?>" class="btn btn-sm px-lg-3 <?= ($status === $data_status_pesanan['status']) ? $btn_style : 'btn-light border-secondary'; ?>">
                    ...
                    <table class="table table-hover datatable">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT pesanan.*, 
                                    ...
                                    INNER JOIN users ON pesanan.id_user = users.id_user
                                    WHERE users.level != 'User' AND pesanan.status = '$status'
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <form method="post" action="<?= base_url('dashboard/order-cashier/action.php?update-order-status=' . $data['id_pesanan'] . '&current-status=' . $data['status']); ?>">
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('dashboard/order-cashier/detail.php?order-id=' . $data['id_pesanan']); ?>" class="btn btn-light">
